      ...
      return (
        <div className="flex items-center gap-2">
          <input
            ...
            data-slot="input"
            className={cn(
              "file:text-foreground selection:bg-primary selection:text-primary-foreground placeholder:text-text-muted dark:bg-input/30 h-9 w-full min-w-0 rounded-md bg-transparent px-3 py-1 text-base text-black transition-[color,box-shadow] outline-none file:inline-flex file:h-7 file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm dark:text-white dark:placeholder:text-white",
              bordered
